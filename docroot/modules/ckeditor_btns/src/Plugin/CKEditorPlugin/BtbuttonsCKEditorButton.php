...
namespace Drupal\ckeditor_btns\Plugin\CKEditorPlugin;
 ...
 * )
 */
class BtbuttonCKEditorButton extends CKEditorPluginBase {
  ...
  public function getButtons() {
    ...
    $path = '/libraries/btbutton';
    return array(
      'btbutton' => array(
        'label' => t('Bootstrap Buttons'),
        'icon' => $path . '/icons/btbutton.png',
      )
    );
  }
