...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/d8cogov/d8cogov-settings.inc');
}

// <DDSETTINGS>
// Please don't edit anything between <DDSETTINGS> tags.
// This section is autogenerated by Acquia Dev Desktop.
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_d8cogov_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_d8cogov_dev_default.inc';
}
// </DDSETTINGS>

$config_directories['sync'] = 'sites/default/files/config_acqTmp-2016-11-30T21.35.39-2915/sync';
